...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="border">
            ...
            <form name="form1" method="post" action="add_doctor" >
                
              ادخل اسم الدكتور :<input type="text" name ="name" >
                <hr>
                <select name="qualification">        
                    <option value="t">استاذ مساعد</option>
                    <option value="tt">دكتور</option>
                    <option value="ttt">استاذ دكتور </option>
                ...
                <hr>
                طريقة الاتصال:<input type="text" name ="cont">
                <hr>
