...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="select_to_delete_tasks" >
                ادخل كود  الماده :<input type="text" name ="material_id" >
                <hr>
               <input type="submit" value="حذف" style="width: 200px ;height:50px">                
            </form>
            </div>
