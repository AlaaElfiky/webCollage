...
<html>
    ...
    <body  class="home">
     ...
     <div class="border">
        ...
        <div> 
                        <div class="blog-second-item single"style="width: 900px ;margin-left: 30px;margin-top: 20px;height: 391px; overflow: scroll">
                    <table class="table table-striped" style="border: 20px;border: solid; width:800px;margin-right: 100px; float: left">
                <tr>
                    <th>موضوع الرسالة </th>
                    <th>تاريخ </th>
                    <th>الاميل</th>
                ...
                <tr>
                    <td><%=g.get(i).getSubject()%></td>
                    <td><%=g.get(i).getMessage_date()%></td>
                    <td><%=g.get(i).getEmail()%></td>
                    <td><%=g.get(i).getName()%></td>
                    <td><form action="Project.jsp">
                            <% session.setAttribute("message"+i,g.get(i).getMessage());%>
                            <input type="hidden" name="any" value=<%= i %> />
                            <input  type="submit" value="قراءة"style="width: 100%;">
                        </form></td>
