...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                ...
                ادخل اسم   الماده  :<input type="text" name ="materail" >
                <hr>
     
                <input type="submit" value="اضافة" name="materail" style="width: 200px ;height:50px">                
                <%session=request.getSession(false);
                session.setAttribute("table_name","weekly");%>
                   </form>
            </div>
