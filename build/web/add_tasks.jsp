  ...
  <%session = request.getSession(false);%>
        ...
        <div class="border">
            <ul class="nav nav-pills nav-stacked" id="me"  style="height: 550px">
              ...
              <div class="col-md-3 footer-grid" style="margin-top: 50px  ;float: right; direction: rtl;color:#648fc5 ; font-size: 14px">
            <form name="form1" method="post" action="add_task" >
                name_material, task_lecture, task_sec, task_project, week_number, month_number
              ادخل اسم الماده:<input type="text" name ="name" >
               المطلوب من المحاضره:<input type="text" name ="lec" >
                 المطلوب  من السكشن<input type="text" name ="sec">
                  تاسك المشروع لهذا الاسبوع<input type="text" name ="task">
                   رقم الاسبوع<input type="text" name ="week">
                   رقم الشهر<input type="text" name ="month">
                <hr>
                <input type="submit" value="اضافة" style="width: 200px ;height:50px">                
            </form>
        </div>
