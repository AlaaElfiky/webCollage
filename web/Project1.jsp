...
<html>
    ...
    <hr/>   
        ...
        <div class="text" style="margin-top: 50px  ; direction: rtl;color:#648FC5; font-size: 20px">
            <form   action="student_project" method="post">
                ادخل اسم المادة لتعرف المطلوب من المشروع هذا الاسبوع    <br><input type="text" name="material_name"><br>
