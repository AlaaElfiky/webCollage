...
<html>
    ...
    <hr/>   
             <li><a href="password.jsp" style="margin-top: 35px;">تغير كلمة السر    </a></li>
                ...
                <div class="text" style="margin-top: 50px  ;float: contour; direction: rtl;color:#648FC5; font-size: 26px">
                           <form class="reg-page"  action="material" method="get">
                               ادخل اسم المادة لتعرف المطلوب هذا الاسبوع    <br><input type="text" name="material_name"><br>
