...
<html>
    ...
    <hr/>   
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ;float: right; direction: rtl;color:#648fc5 ; font-size: 14px">
            ...
            اسم المستخدم   : <b style=" border-radius: 2px;border: 2px solid #EEEEEE;padding-left: 45px;    padding-right: 10px; padding-bottom: 5px; padding-top: 4px;"><%= student.getUser_name()%></b><hr/>
            <form name="form1" method="post" action="Password" onsubmit="return valid()">
                كلمة السر         :<input type="password" name ="old_password" id="p"><hr/>

                كلمة السر الجديد     :<input type="password" name ="new_password" id="p1"><hr/>

                اعد كتابة كلمة السر  :<input type="password" name ="reenter_password" id="p2"><hr/>
