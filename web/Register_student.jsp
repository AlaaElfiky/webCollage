...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="RegistrationStudent" class="reg-page">
                ادخل اسم المستخدم:<input type="text" name ="user_name" >
                <hr>
                ادخل الاسم رباعي     :<input type="text" name ="name" >
                <hr>
                <select name="year">        
               ...
               <hr>
               كلمة السر:<input type="password" name ="password">
                               <hr>
