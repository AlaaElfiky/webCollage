...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="border">
            ...
            <form name="form1" method="post" action="add_material" >
                name_material, year, specialization, doctor_id, source_material
              ادخل اسم الماده:<input type="text" name ="name" >
                <hr>
                <select name="year">        
                    <option value="1">فرقه اولى</option>
                    <option value="2">فرقه تانيه</option>
                    <option value="3">فرقه تالته </option>
                ...
                <hr>
                كودالدكتور:<input type="text" name ="doctor_id">
                <hr>
                 لينك الماده:<input type="text" name ="source">
                <hr>
