  ...
  <%session = request.getSession(false);%>
        ...
        <div class="border">
            <ul class="nav nav-pills nav-stacked" id="me"  style="height: 550px">
             ...
             <div class="aa" style="margin-top: 50px;margin-right:400px  ; direction: rtl;color: red; font-size: 20px">
                           <form class="reg-page"  action="admin_send" method="get">
            موضوع الرسالة     <br><input type="text" name="subject"><br>
            موجه الي مين ؟<br><input type="text" name="to"><br>
            محتوي الرسالة  <br><textarea value="Message" name="message_web" style="width: 200px;" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'الرسالة';}">الرسالة</textarea><br><br>
