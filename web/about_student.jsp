...
<html>
    ...
    <hr/>   
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color: red; font-size: 20px;float: right">
            <div class="text" >
                

                    <b style="color:#648fc5 ;font-size: 24px ;float: right"> اسم الطالب  : </b>       <%= student.getName()%> <br>  
                    <hr >

                    <b style="color: #648fc5 ;font-size: 24px; float: right">اسم المستخدم  :     </b>     <%= student.getUser_name()%><br>      
                    <hr >
                    <b style="color: #648fc5 ;font-size: 24px ;float: right">الفرقة  : </b>               <%= student.getYear()%> <br>
                     <hr >
                    <b style="color: #648fc5 ;font-size: 24px ;float: right"> التخصص : </b> <%= student.getSpecialization()%> <br>  
                 <hr >
