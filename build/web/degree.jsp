...
<div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="degree" class="reg-page">
                كود الطالب:<input type="text" name ="student_id" >
                <hr>
                اسم المادة     :<input type="text" name ="material_name" >
                <hr>
              درجة العملي :<input type="text" name ="applied" >
                             <hr>

              درجةالتحريري :<input type="text" name ="final" >

                <hr>
                            السنة الدراسية :<input type="text" name ="year" >
