...
<html>
  ...
  <%session = request.getSession(false);%>
      ...
      <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
               ...
               <hr>
                <%
           session.setAttribute("t","كود الدكتور ");
           session.setAttribute("t2","اسم الدكتور ");
           session.setAttribute("t3","التخصص");
           session.setAttribute("t4","طريقة الاتصال");
               %>
        ...
        <div class="footer" style="margin-top: 470px">
            <div class="container">
