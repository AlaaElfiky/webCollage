  ...
  <%session = request.getSession(false);%>
        ...
        <%
            ...
            Weekly w=(Weekly)session.getAttribute("weekly");
              %>
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="update_tasks" >
        <b style="color:#648fc5 ;font-size: 24px ;float: right"> كودالطالب  : </b>  <%=w.getId()%> <br>  
                    <hr >

                <hr>
                   اسم المادة :<input type="text" name ="name_material" value="<%=w.getName_material() %>">
                <hr>
                تاسك  الماحاضرة<input type="text" name ="task_lecture" value="<%=w.getTask_lecture() %>">
                <hr>
                  تاسك السكشن    :<input type="text" name ="task_sec" value="<%=w.getTask_sec()%>">
                <hr>
                
                  تاسك المشروع     :<input type="text" name ="task_project" value="<%=w.getTask_project()%>">
                <hr>
             رقم الاسبوع  :<input type="text" name ="week_number" value="<%=w.getWeek_number() %>">
                <hr>
                <hr>
             رقم الشهر  :<input type="text" name ="month_number" value="<%=w.getMonth_number() %>">
                <hr>
              
              
                              
               <input type="submit" value="تعديل" style="width: 200px ;height:50px">                
            </form>
            </div>
