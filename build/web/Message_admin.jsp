  ...
  <%session = request.getSession(false);%>
        ...
        <div class="border">
            <ul class="nav nav-pills nav-stacked" id="me"  style="height: 550px">
                ...
                <hr/>
                <li><a href="mesage_admin.jsp" style="margin-top: 35px;">الواردة</a></li>
                <hr/>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648FC5; font-size: 20px">




            <b style="font-size: 24px"><br><%=session.getAttribute("message")%><br>     
