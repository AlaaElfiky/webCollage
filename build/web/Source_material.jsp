...
<html>
    ...
    <body  class="home">
        ...
        <iframe src=<%=session.getAttribute("source")%>  style="width: 850px ;height: 400px;border: 2px solid #2DBEEA ;margin-left: 23px;margin-top: 2px ;border-radius: 5px"> </iframe>
