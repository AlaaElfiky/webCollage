...
<html>
    ...
    <hr/>   
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color: red; font-size: 20px">
                           <form   action="material_source" method="post">
            ادخل اسم المادة لتحميل الملفات الخاصة بها    <br><input type="text" name="material_name"><br>
