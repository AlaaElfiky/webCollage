...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <%
            ...
            session=request.getSession(false);
            Material d=(Material)session.getAttribute("material");
              %>
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="update_material" >
                       ادخل اسم الماده:<input type="text" name ="name" value="<%=d.getName_material()%>" >
                <hr>
                ادخل الفرقه الدراسيه     :<input type="text" name ="year" value="<%=d.getYear()%>">
                <hr>
                ادخل التخصص     :<input type="text" name ="sp" value="<%=d.getSpecialization()%>">
                <hr>
                  ادخل كود الدكتور    :<input type="text" name ="doctor_id" value="<%=d.getDoctor_id()%>">
                <hr>
                 ادخل لينك الماده :<input type="text" name ="source" value="<%=d.getSource_material()%>">
                <hr>
