  ...
  <%session = request.getSession(false);%>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="update" >
                       ادخل اسم المستخدم:<input type="text" name ="user_name" value="<%=student.getUser_name()%>" >
                <hr>
                ادخل الاسم رباعي     :<input type="text" name ="name" value="<%=student.getName()%>">
                <hr>
                ادخل السنة     :<input type="text" name ="year" value="<%=student.getYear()%>">
                <hr>
                  ادخل القسم     :<input type="text" name ="sp" value="<%=student.getSpecialization()%>">
                <hr>
              
                كلمة السر:<input type="password" name ="password" value="<%=student.getPassword()%>">
                               <hr>
