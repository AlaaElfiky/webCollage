...
<html>
  ...
  <%session = request.getSession(false);%>
        ...
        <div class="col-md-3 footer-grid" style="margin-top: 50px  ; direction: rtl;color:#648fc5 ; font-size: 14px">
                   <form name="form1" method="post" action="update_doctor" >
                       ادخل اسم الدكتور:<input type="text" name ="name" value="<%=d.getDoctor_name()%>" >
                <hr>
                ادخل التخصص     :<input type="text" name ="sp" value="<%=d.getSpecialization()%>">
                <hr>
                ادخل الدرجه العلميه     :<input type="text" name ="qu" value="<%=d.getQualification()%>">
                <hr>
                  ادخل طريقه الاتصال     :<input type="text" name ="cont" value="<%=d.getConnected()%>">
                <hr>
